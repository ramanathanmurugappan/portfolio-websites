...
export default function Education() {
  return (
    <div className="container flex flex-col gap-[40px]">
      ...
      {/* Education Card */}
      <div 
        className="rounded-[32px] bg-[#f7f7f7] p-[40px] flex flex-col md:flex-row items-center justify-between gap-[24px]"
      ...
      >
        <div className="flex flex-col gap-[8px]">
          ...
          <p className="text-[14px] text-black/50 font-semibold">
        ...
        {/* Research Experience */}
        <div 
          className="rounded-[24px] bg-white p-[24px] flex flex-col gap-[8px] max-w-[400px]"
          style={{ border: '1px solid rgba(0,0,0,0.04)' }}
        >
