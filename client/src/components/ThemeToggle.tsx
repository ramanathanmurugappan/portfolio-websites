  ...
  return (
    <div className="fixed top-6 right-6 z-40 flex items-center gap-[8px]">
      ...
      <a
        ...
        download
        className="flex items-center gap-[7px] px-[14px] h-[48px] rounded-[12px] bg-white dark:bg-[#1a1a1a] text-black/55 dark:text-white/55 hover:text-[#1e6ef4] dark:hover:text-[#1e6ef4] border border-black/[0.07] dark:border-white/[0.07] shadow-sm hover:shadow-md transition-all duration-200 ease-out active:scale-95 hover:scale-105 text-[13px] font-semibold select-none"
      ...
      <button
        onClick={toggleTheme}
        className="w-[48px] h-[48px] rounded-[12px] flex items-center justify-center transition-all duration-200 ease-out active:scale-95 hover:scale-105 bg-white dark:bg-[#1a1a1a] text-black/40 dark:text-white/40 hover:text-black/60 dark:hover:text-white/60 hover:bg-black/5 dark:hover:bg-white/5 border border-black/[0.07] dark:border-white/[0.07] shadow-sm hover:shadow-md"
